...
type Options struct {
	...
	SubagentsPaths            []string               `json:"subagents_paths,omitempty" jsonschema:"description=Paths to directories containing subagent markdown files,example=~/.config/crush/subagents,example=./.crush/subagents"`
